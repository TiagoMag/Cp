...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Varid{nil}}{\Varid{f}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\mathrel{=}\uncurry{(\plus )}\comp (\Varid{k}\times\Varid{id}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{dic\char95 rd}\;\Varid{p}\;\Varid{t}\mathrel{=}\Varid{hyloExp}\;\Varid{cata}\;\Varid{ana}\mathbin{\$}(\Varid{p},\Varid{t})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{ana}\;(\Varid{p},\Conid{Var}\;\Varid{o})\mathrel{=}i_1\;\Varid{o}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{ana}\;(\Varid{p},\Conid{Term}\;\Varid{o}\;\Varid{l})\mid \length \;\Varid{p}\equiv \mathrm{0}\mathrel{=}i_2\;(\Varid{o},\Varid{k}\;(\Varid{p},[\mskip1.5mu \mskip1.5mu])){}\<[E]%
\\
\>[3]{}\hsindent{18}{}\<[21]%
\>[21]{}\mid \length \;\Varid{o}\equiv \mathrm{0}\mathrel{=}i_2\;(\Varid{o},\Varid{k}\;(\Varid{p},\Varid{l})){}\<[E]%
\\
\>[3]{}\hsindent{18}{}\<[21]%
\>[21]{}\mid \Varid{singl}\;(\Varid{head}\;{}\<[36]%
\>[36]{}\Varid{p})\equiv \Varid{o}\mathrel{=}i_2\;(\Varid{o},\Varid{k}\;(\Varid{tail}\;\Varid{p},\Varid{l})){}\<[E]%
\\
\>[3]{}\hsindent{18}{}\<[21]%
\>[21]{}\mid \Varid{otherwise}\mathrel{=}i_2\;(\Varid{o},[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{k}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{foldr}\;(\lambda \Varid{x}\;\Varid{acc}\to (\Varid{a},\Varid{x})\mathbin{:}\Varid{acc})\;[\mskip1.5mu \mskip1.5mu]\;\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{cata}\mathrel{=}\alt{\Conid{Just}\comp \Varid{singl}}{\Varid{h}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{h}\mathrel{=}{}\<[8]%
...
\xymatrix@C=2cm{
    \ensuremath{\fun{BTree} \;\Varid{a}}
           \ar[d]_-{\ensuremath{\cata{\Varid{g}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{+}\Conid{X}\mathbin{\uparrow}\mathrm{2}}
           \ar[d]^{\ensuremath{(\Conid{Maybe}\;\Varid{a}))\mathbin{+}\Varid{maisDir}}}
           \ar[l]_-{\ensuremath{\Varid{inBTree}}}
\\
     \ensuremath{\Conid{Maybe}\;\Varid{a}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times\Varid{expn}\;((\Conid{M}))\;\mathrm{2}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{bdtGC}\mathrel{=}\Conid{Query}\;(\text{\ttfamily \char34 Chuva~na~ida?\char34},(\Conid{Dec}\;\text{\ttfamily \char34 Precisa\char34},\Conid{Query}\;(\text{\ttfamily \char34 Chuva~no~regresso\char34},(\Conid{Dec}\;\text{\ttfamily \char34 Precisa\char34},\Conid{Dec}\;\text{\ttfamily \char34 N~precisa\char34})))){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;(\Varid{a},\anonymous )\mathrel{=}\Conid{Leaf}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\
\>[B]{}\Varid{anita}\mathrel{=}\Conid{Query}\;(\text{\ttfamily \char34 2a-feira?\char34},(\Conid{Query}\;(\text{\ttfamily \char34 Chuva~na~ida?\char34},(\Conid{Dec}\;\text{\ttfamily \char34 Precisa\char34},\Conid{Query}\;(\text{\ttfamily \char34 Chuva~no~regresso\char34},(\Conid{Dec}\;\text{\ttfamily \char34 Precisa\char34},\Conid{Dec}\;\text{\ttfamily \char34 N~precisa\char34})))),\Conid{Dec}\;\text{\ttfamily \char34 N~precisa\char34})){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g1}\;(\Varid{a},\Varid{bt})\mathrel{=}\Varid{return}\;(\Conid{Leaf}\;\Varid{a},\Varid{bt}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;((\Varid{l},\Varid{r}),\Conid{Empty})\mathrel{=}\Varid{return}\;(\Conid{Fork}\;(\Varid{l}\;\Conid{Empty},\Varid{r}\;\Conid{Empty})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;((\Varid{l},\Varid{r}),\Conid{Node}\;(\Conid{D}\;((\Varid{bool},\Varid{p})\mathbin{:}\Varid{xs}),(\Conid{Empty},\Conid{Empty})))\mid \Varid{bool}\equiv \Conid{True}\mathrel{=}\Varid{return}\;(\Varid{l}\;\Conid{Empty}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{geraTrunchet}\;(\Varid{a},\Varid{b})\mathrel{=}\mathsf{fmap}\;\Varid{pictures}\mathbin{\$}\Varid{\Conid{M}.join}\mathbin{\$}\mathsf{fmap}\;(\Varid{permuta}\comp \map \;\uncurry{\Varid{put}})\mathbin{\$}\Varid{liftM2}\;\Varid{zip}\;\Varid{posicoes}\;\Varid{mosaicos}{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mathbf{where}\;\Varid{mosaicos}\mathrel{=}\Varid{auxGera}\;(\Varid{a}\mathbin{*}\Varid{b}){}\<[E]%
\\
\>[21]{}\hsindent{6}{}\<[27]%
...
\\
\>[B]{}\Varid{monadCompo}\mathrel{=}\Varid{geraTrunchet}\mathbin{>=>}\Varid{display}\;\Varid{janela}\;\Varid{white}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment gera mosaicos aleatorios}{}\<[E]%
\\
\>[B]{}\Varid{auxGera}\mathbin{::}\Conid{Int}\to \fun{IO}\;[\mskip1.5mu \Conid{Picture}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxGera}\;\Varid{x}\mathrel{=}\Varid{replicateM}\;\Varid{x}\;(\mathsf{fmap}\;\Varid{f}\mathbin{\$}\Varid{randomRIO}\;(\mathrm{0}\mathbin{::}\Conid{Integer},\mathrm{1}\mathbin{::}\Conid{Integer})){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
