...
\xymatrix@C=4cm{
    \ensuremath{{(\Conid{A}\times{\mathit B}^*)}^*}
           \ar[d]_-{\ensuremath{\cata{\alt{\Varid{nil}}{\uncurry{(\plus )}\comp (\Varid{k}\times\Varid{id})}}}}
           \ar[r]^-{\ensuremath{\Varid{outList}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}{(\Conid{A}\times\mathit B)}^*\times{(\Conid{A}\times{\mathit B}^*)}^*}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\cata{\alt{\Varid{nil}}{\uncurry{(\plus )}\comp (\Varid{k}\times\Varid{id})}}}}
\\
     \ensuremath{{(\Conid{A}\times\mathit B)}^*}
&
     \ensuremath{\mathrm{1}\mathbin{+}{(\Conid{A}\times\mathit B)}^*\times{(\Conid{A}\times\mathit B)}^*}
           \ar[l]^-{\ensuremath{\alt{\Varid{nil}}{\uncurry{(\plus )}\comp (\Varid{k}\times\Varid{id})}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{discollect}\mathrel{=}\Varid{cataList}\;\Varid{g}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Varid{nil}}{\uncurry{(\plus )}\comp (\Varid{k}\times\Varid{id})}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{k}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{foldr}\;(\lambda \Varid{x}\;\Varid{acc}\to (\Varid{a},\Varid{x})\mathbin{:}\Varid{acc})\;[\mskip1.5mu \mskip1.5mu]\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=4cm{
    \ensuremath{\Conid{Exp}\;\Conid{String}\;\Conid{String}}
           \ar[d]_-{\ensuremath{\cata{\alt{\Varid{f}}{\Varid{k}}}}}
           \ar[r]^-{\ensuremath{\Varid{outList}}}
&
    \ensuremath{\Conid{String}\mathbin{+}\Conid{String}\times{(\Conid{Exp}\;\Conid{String}\;\Conid{String})}^*}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\map \;\cata{\alt{\Varid{f}}{\Varid{k}}}}}
\\
     \ensuremath{{(\Conid{String}\times\Conid{String})}^*}
&
     \ensuremath{\Conid{String}\mathbin{+}\Conid{String}\times{({(\Conid{String}\times\Conid{String})}^*)}^*}
           \ar[l]^-{\ensuremath{\alt{\Varid{f}}{\Varid{k}}}}
}
\end{eqnarray*}
...
\\[\blanklineskip]%
\>[B]{}\Varid{tar}\mathbin{::}\Conid{Dict}\to [\mskip1.5mu (\Conid{String},\Conid{String})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{tar}\mathrel{=}\Varid{cataExp}\;\Varid{g}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Varid{f}}{\Varid{k}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\mathrel{=}\Varid{singl}\comp (,)\;\text{\ttfamily \char34 \char34}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{k}\;(\Varid{a},\Varid{lst})\mathrel{=}\Varid{concatMap}\;(\map \;((\plus )\;\Varid{a}\times\Varid{id}))\;\Varid{lst}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{String}\mathbin{+}\Conid{String}\times{({(\Conid{String})}^*)}^*}
           \ar[l]_-{\ensuremath{\Varid{traducoes}}}
\\
     \ensuremath{\Conid{Exp}\;\Conid{String}\;\Conid{String}}
           \ar[u]^-{\ensuremath{\cata{\Varid{traducoes}}}}
&
     \ensuremath{\Conid{String}\mathbin{+}\Conid{String}\times{(\Conid{Exp}\;\Conid{String}\;\Conid{String})}^*}
           \ar[u]_-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\map \;\cata{\Varid{traducoes}}}}
           \ar[l]_-{\ensuremath{\Varid{inExp}}}
\\
     \ensuremath{\Conid{String}\times(\Conid{Exp}\;\Conid{String}\;\Conid{String})}
           \ar[u]^-{\ensuremath{\ana{\Varid{procura}}}}
           \ar[r]_-{\ensuremath{\Varid{procura}}}
&
     \ensuremath{\Conid{String}\mathbin{+}\Conid{String}\times(\Conid{String}\times{(\Conid{Exp}\;\Conid{String}\;\Conid{String})}^*)}
           \ar[u]_-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\map \;\ana{\Varid{procura}}}}
}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dic\char95 rd}\mathbin{::}\Conid{String}\to (\Conid{Exp}\;\Conid{String}\;\Conid{String})\to \Conid{Maybe}\;[\mskip1.5mu \Conid{String}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{dic\char95 rd}\;\Varid{p}\;\Varid{t}\mathrel{=}\Varid{hyloExp}\;\Varid{traducoes}\;\Varid{procura}\mathbin{\$}(\Varid{p},\Varid{t})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{procura}\;(\Varid{p},\Conid{Var}\;\Varid{o})\mathrel{=}i_1\;\Varid{o}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{procura}\;(\Varid{p},\Conid{Term}\;\Varid{o}\;\Varid{l})\mid \length \;\Varid{p}\equiv \mathrm{0}\mathrel{=}i_2\;(\Varid{o},\Varid{k}\;(\Varid{p},[\mskip1.5mu \mskip1.5mu])){}\<[E]%
\\
\>[3]{}\hsindent{21}{}\<[24]%
\>[24]{}\mid \length \;\Varid{o}\equiv \mathrm{0}\mathrel{=}i_2\;(\Varid{o},\Varid{k}\;(\Varid{p},\Varid{l})){}\<[E]%
\\
\>[3]{}\hsindent{21}{}\<[24]%
\>[24]{}\mid \Varid{singl}\;(\Varid{head}\;{}\<[39]%
\>[39]{}\Varid{p})\equiv \Varid{o}\mathrel{=}i_2\;(\Varid{o},\Varid{k}\;(\Varid{tail}\;\Varid{p},\Varid{l})){}\<[E]%
\\
\>[3]{}\hsindent{21}{}\<[24]%
\>[24]{}\mid \Varid{otherwise}\mathrel{=}i_2\;(\Varid{o},[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{k}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{foldr}\;(\lambda \Varid{x}\;\Varid{acc}\to (\Varid{a},\Varid{x})\mathbin{:}\Varid{acc})\;[\mskip1.5mu \mskip1.5mu]\;\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{traducoes}\mathrel{=}\alt{\Conid{Just}\comp \Varid{singl}}{\Varid{h}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{h}\mathrel{=}{}\<[8]%
\>[8]{}\Varid{\Conid{Cp}.cond}\;((\equiv )\;([\mskip1.5mu \mskip1.5mu])\comp \Varid{nub}\comp \Varid{concat}\comp \Varid{catMaybes}\comp \p2)\;\underline{\Conid{Nothing}}\;(\Conid{Just}\comp \Varid{nub}\comp \Varid{concat}\comp \Varid{catMaybes}\comp \p2){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{dic\char95 in}\;\Varid{p}\;\Varid{t}\;\Varid{d}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\newpage
\subsection*{Problema 2}
...
\xymatrix@C=2cm{
    \ensuremath{\fun{BTree} \;\Conid{A}}
           \ar[d]_-{maisDir = \ensuremath{\cata{\Varid{g}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{+}{\Conid{X}}^{\mathrm{2}}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times{\Varid{maisDir}}^{\mathrm{2}}}}
           \ar[l]_-{\ensuremath{\Varid{inBTree}}}
\\
     \ensuremath{\Conid{Maybe}\;\Varid{a}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times{\Conid{M}}^{\mathrm{2}}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Varid{w}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{w}\;(\Varid{a},(\anonymous ,\Conid{Nothing}))\mathrel{=}\Conid{Just}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{w}\;(\Varid{a},(\anonymous ,\Conid{Just}\;\Varid{b}))\mathrel{=}\Conid{Just}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\fun{BTree} \;\Conid{A}}
           \ar[d]_-{maisEsq = \ensuremath{\cata{\Varid{g}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{+}{\Conid{X}}^{\mathrm{2}}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times{\Varid{maisEsq}}^{\mathrm{2}}}}
           \ar[l]_-{\ensuremath{\Varid{inBTree}}}
\\
     \ensuremath{\Conid{Maybe}\;\Varid{a}}
&
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{w}\;(\Varid{a},(\Conid{Nothing},\anonymous ))\mathrel{=}\Conid{Just}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{w}\;(\Varid{a},(\Conid{Just}\;\Varid{b},\anonymous ))\mathrel{=}\Conid{Just}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\fun{BTree} \;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{insOrd'}\mathrel{=}\cata{\Varid{g}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{+}{\Conid{X}}^{\mathrm{2}}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times{\Varid{insOrd'}}^{\mathrm{2}}}}
           \ar[l]_-{\ensuremath{\Varid{inBTree}}}
\\
     \ensuremath{\Conid{X}\times\Conid{X}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times{(\Conid{X}\times\Conid{X})}^{\mathrm{2}}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{insOrd}\;\Varid{a}\;\Varid{x}\mathrel{=}\p1\mathbin{\$}\Varid{insOrd'}\;\Varid{a}\;\Varid{x}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{insOrd'}\;\Varid{x}\mathrel{=}\Varid{cataBTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{(\Conid{Node}\;(\Varid{x},(\Conid{Empty},\Conid{Empty})),\Conid{Empty})}}{\Varid{w}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{w}\;(\Varid{a},((\Varid{subesq},\Varid{subesqog}),(\Varid{subdir},\Varid{subdirog}))){}\<[E]%
\\
\>[9]{}\hsindent{22}{}\<[31]%
\>[31]{}\mid \Varid{x}\mathbin{<}\Varid{a}\mathrel{=}((\Conid{Node}\;(\Varid{a},(\Varid{subesq},\Varid{subdirog}))),(\Conid{Node}\;(\Varid{a},(\Varid{subesqog},\Varid{subdirog})))){}\<[E]%
\\
\>[9]{}\hsindent{22}{}\<[31]%
\>[31]{}\mid \Varid{x}\mathbin{>}\Varid{a}\mathrel{=}((\Conid{Node}\;(\Varid{a},(\Varid{subesqog},\Varid{subdir}))),(\Conid{Node}\;(\Varid{a},(\Varid{subesqog},\Varid{subdirog})))){}\<[E]%
\\
\>[9]{}\hsindent{22}{}\<[31]%
\>[31]{}\mid \Varid{otherwise}\mathrel{=}((\Conid{Node}\;(\Varid{a},(\Varid{subesqog},\Varid{subdirog}))),(\Conid{Node}\;(\Varid{a},(\Varid{subesqog},\Varid{subdirog})))){}\<[E]%
\\
...
\xymatrix@C=2cm{
    \ensuremath{\fun{BTree} \;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{isOrd'}\mathrel{=}\cata{\Varid{g}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{+}{\Conid{X}}^{\mathrm{2}}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times{\Varid{isOrd'}}^{\mathrm{2}}}}
           \ar[l]_-{\ensuremath{\Varid{inBTree}}}
\\
     \ensuremath{(\Conid{Bool}\times\Conid{X})}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times{(\Conid{Bool}\times\Conid{X})}^{\mathrm{2}}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{(\Conid{True},\Conid{Empty})}}{\Varid{c}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{c}\;(\Varid{a},((\Conid{False},\Varid{b2}),(\Varid{c1},\Varid{c2})))\mathrel{=}(\Conid{False},\Conid{Node}\;(\Varid{a},(\Varid{b2},\Varid{c2}))){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{c}\;(\Varid{a},((\Varid{b1},\Varid{b2}),(\Conid{False},\Varid{c2})))\mathrel{=}(\Conid{False},\Conid{Node}\;(\Varid{a},(\Varid{b2},\Varid{c2}))){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{c}\;(\Varid{a},((\Conid{True},\Varid{b2}),(\Conid{True},\Varid{c2})))\mathrel{=}\mathbf{case}\;(\Varid{maisDir}\;\Varid{b2},\Varid{maisEsq}\;\Varid{c2})\;\mathbf{of}{}\<[E]%
\\
\>[9]{}\hsindent{34}{}\<[43]%
\>[43]{}(\Conid{Nothing},\Conid{Nothing})\to (\Conid{True},\Conid{Node}\;(\Varid{a},(\Varid{b2},\Varid{c2}))){}\<[E]%
\\
\>[9]{}\hsindent{34}{}\<[43]%
\>[43]{}(\Conid{Just}\;\Varid{x},\Conid{Nothing})\to (\Varid{x}\leq \Varid{a},\Conid{Node}\;(\Varid{a},(\Varid{b2},\Varid{c2}))){}\<[E]%
\\
\>[9]{}\hsindent{34}{}\<[43]%
\>[43]{}(\Conid{Nothing},\Conid{Just}\;\Varid{x})\to (\Varid{x}\geq \Varid{a},\Conid{Node}\;(\Varid{a},(\Varid{b2},\Varid{c2}))){}\<[E]%
\\
\>[9]{}\hsindent{34}{}\<[43]%
\>[43]{}(\Conid{Just}\;\Varid{x},\Conid{Just}\;\Varid{y}){}\<[61]%
\>[61]{}\to (\Varid{x}\leq \Varid{a}\mathrel{\wedge}\Varid{y}\geq \Varid{a},\Conid{Node}\;(\Varid{a},(\Varid{b2},\Varid{c2}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rrot}\;\Varid{a}\mathord{@}(\Conid{Node}\;(\Varid{rz},(\Conid{Empty},\Varid{tr})))\mathrel{=}{}\<[34]%
\>[34]{}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{rrot}\;\Varid{a}\mathord{@}(\Conid{Node}\;(\Varid{rz},(\Conid{Node}\;(\Varid{l},(\Varid{ll},\Varid{lr})),\Varid{tr})))\mathrel{=}\Conid{Node}\;(\Varid{l},(\Varid{ll},\Conid{Node}\;(\Varid{rz},(\Varid{lr},\Varid{tr})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{lrot}\;{}\<[7]%
\>[7]{}\Varid{a}\mathord{@}(\Conid{Node}\;(\Varid{rz},(\Varid{tl},\Conid{Empty})))\mathrel{=}{}\<[35]%
\>[35]{}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{lrot}\;{}\<[7]%
\>[7]{}\Varid{a}\mathord{@}(\Conid{Node}\;(\Varid{rz},(\Varid{tl},\Conid{Node}\;(\Varid{r},(\Varid{rl},\Varid{rr})))))\mathrel{=}\Conid{Node}\;(\Varid{r},(\Conid{Node}\;(\Varid{rz},(\Varid{tl},\Varid{rl})),\Varid{rr})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\fun{BTree} \;\Conid{A}}
           \ar[d]_-{\ensuremath{\cata{\Varid{g}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times{\Conid{X}}^{\mathrm{2}}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times{\cata{\Varid{g}}}^{\mathrm{2}}}}
           \ar[l]_-{\ensuremath{\Varid{inBTree}}}
\\
     \ensuremath{{\Conid{X}}^{\Conid{Bool}}\mathbin{*}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times{({\Conid{X}}^{\Conid{Bool}\mathbin{*}})}^{\mathrm{2}}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\>[14]{}(\Varid{flip}\;\Varid{cataBTree}\;\Varid{t}\;\Varid{g})\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\lambda \Varid{x}\to \underline{\Conid{Empty}}}{\Varid{curry}\;\Varid{k}}{}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{k}\;((\Varid{raiz},(\Varid{t1},\Varid{t2})),\Varid{l})\mathrel{=}\mathbf{if}\;\length \;\Varid{l}\equiv \mathrm{0}{}\<[E]%
\\
\>[17]{}\hsindent{22}{}\<[39]%
\>[39]{}\mathbf{then}\;\Conid{Node}\;(\Varid{raiz},((\Varid{t1}\;\Varid{l}),(\Varid{t2}\;\Varid{l}))){}\<[E]%
\\
\>[17]{}\hsindent{19}{}\<[36]%
\>[36]{}\mathbf{else}\;\mathbf{if}\;\Varid{head}\;\Varid{l}\;\mathbf{then}\;\Varid{rrot}\mathbin{\$}\Conid{Node}\;(\Varid{raiz},((\Varid{t1}\;(\Varid{tail}\;\Varid{l})),(\Varid{t2}\;[\mskip1.5mu \mskip1.5mu]))){}\<[E]%
\\
\>[17]{}\hsindent{18}{}\<[35]%
\>[35]{}\mathbf{else}\;\Varid{lrot}\mathbin{\$}\Conid{Node}\;(\Varid{raiz},((\Varid{t1}\;[\mskip1.5mu \mskip1.5mu]),(\Varid{t2}\;(\Varid{tail}\;\Varid{l})))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\newpage
\subsection*{Problema 3}
...
\\
\>[B]{}\Varid{outBdt}\;(\Conid{Query}\;(\Varid{s},(\Varid{q1},\Varid{q2})))\mathrel{=}i_2\;(\Varid{s},(\Varid{q1},\Varid{q2})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baseBdt}\;\Varid{f}\;\Varid{g}\;\Varid{h}\mathrel{=}\Varid{f}+(\Varid{g}\times(\Varid{h}\times\Varid{h})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recBdt}\;\Varid{f}\mathrel{=}\Varid{baseBdt}\;\Varid{id}\;\Varid{id}\;\Varid{f}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  bdt testes}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bdtGC}\mathbin{::}\Conid{Bdt}\;[\mskip1.5mu \Conid{Char}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{bdtGC}\mathrel{=}\Conid{Query}\;(\text{\ttfamily \char34 Chuva~na~ida?\char34},(\Conid{Dec}\;\text{\ttfamily \char34 Precisa\char34},{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Conid{Query}\;(\text{\ttfamily \char34 Chuva~no~regresso\char34},{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}(\Conid{Dec}\;\text{\ttfamily \char34 Precisa\char34},\Conid{Dec}\;\text{\ttfamily \char34 N~precisa\char34})))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{A}\mathbin{+}\Conid{String}\times{(\Conid{Bdt}\;\Conid{A})}^{\mathrm{2}}}
...
&
     \ensuremath{\Conid{A}\mathbin{+}\Conid{String}\times{\mathit C}^{\mathrm{2}}}
           \ar[u]_-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times{\ana{\Varid{g}}\;\mathrm{2}}^{\cdot }}}
}
\end{eqnarray*}
...
\xymatrix@C=4cm{
    \ensuremath{\Conid{Bdt}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\cata{\alt{\Conid{Leaf}}{\Conid{Fork}\comp \p2}}}}
           \ar[r]^-{\ensuremath{\Varid{outBdt}}}
&
    \ensuremath{\Conid{A}\mathbin{+}\Conid{String}\times{\Conid{Bdt}\;\Conid{A}}^{\mathrm{2}}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\map \;\cata{\alt{\Conid{Leaf}}{\Conid{Fork}\comp \p2}}}}
\\
     \ensuremath{\mathsf{LTree}\;\Conid{A}}
&
     \ensuremath{\Conid{A}\mathbin{+}\Conid{String}\times{(\Conid{Ltree}\;\Conid{A})}^{\mathrm{2}}}
           \ar[l]^-{\ensuremath{\alt{\Conid{Leaf}}{\Conid{Fork}\comp \p2}}}
}
\end{eqnarray*}
...
\xymatrix@C=4cm{
    \ensuremath{\mathsf{LTree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\cata{\alt{\Varid{g1}}{\Varid{g2}}}}}
           \ar[r]^-{\ensuremath{\Varid{outBdt}}}
&
    \ensuremath{\Conid{A}\mathbin{+}{(\mathsf{LTree}\;\Conid{A})}^{\mathrm{2}}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\cata{\alt{\Varid{g1}}{\Varid{g2}}}}}
\\
     \ensuremath{{\mathsf{LTree}\;\Conid{A}}^{{\Conid{Bool}}^{\cdot }\mathbin{*}}}
&
     \ensuremath{\Conid{A}\mathbin{+}{({\mathsf{LTree}\;\Conid{A}}^{\Conid{Bool}\mathbin{*}})}^{\mathrm{2}}}
...
\\
\>[B]{}\Varid{navLTree}\;\Varid{lt}\;\Varid{lstB}\mathrel{=}(\Varid{cataLTree}\;\Varid{g}\;\Varid{lt})\;\Varid{lstB}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Varid{curry}\;\Varid{g1}}{\Varid{curry}\;\Varid{g2}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\mathrel{=}\Conid{Leaf}\comp \p1{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;((\Varid{l},\Varid{r}),\Varid{lst})\mid \length \;\Varid{lst}\equiv \mathrm{0}\mathrel{=}\Conid{Fork}\;(\Varid{l}\;\Varid{lst},\Varid{r}\;\Varid{lst}){}\<[E]%
\\
\>[3]{}\hsindent{15}{}\<[18]%
\>[18]{}\mid \Varid{head}\;\Varid{lst}\equiv \Conid{True}\mathrel{=}\Varid{l}\mathbin{\$}\Varid{tail}\mathbin{\$}\Varid{lst}{}\<[E]%
\\
\>[3]{}\hsindent{15}{}\<[18]%
\>[18]{}\mid \Varid{otherwise}\mathrel{=}\Varid{r}\mathbin{\$}\Varid{tail}\mathbin{\$}\Varid{lst}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{A}\mathbin{+}{(\mathsf{LTree}\;\Conid{A})}^{\mathrm{2}}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\cata{\alt{\Varid{g1}}{\Varid{g2}}}}}
\\
     \ensuremath{{\mathsf{LTree}\;\Conid{A}}^{\fun{BTree} \;\Conid{Bool}}}
&
     \ensuremath{\Conid{A}\mathbin{+}{({\mathsf{LTree}\;\Conid{A}}^{\fun{BTree} \;\Conid{Bool}})}^{\mathrm{2}}}
           \ar[l]^-{\ensuremath{\alt{\Varid{g1}}{\Varid{g2}}}}
}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{bnavLTree}\;\Varid{lt}\;\Varid{bt}\mathrel{=}(\Varid{cataLTree}\;\Varid{g}\;\Varid{lt})\;\Varid{bt}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{curry}\;\Varid{g1}}{\Varid{curry}\;\Varid{g2}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g1}\;(\Varid{a},\anonymous )\mathrel{=}\Conid{Leaf}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;((\Varid{l},\Varid{r}),\Conid{Empty})\mathrel{=}\Conid{Fork}\;(\Varid{l}\;\Conid{Empty},\Varid{r}\;\Conid{Empty}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;((\Varid{l},\Varid{r}),\Conid{Node}\;(\Varid{rz},(\Conid{Empty},\Conid{Empty})))\mid \Varid{rz}\equiv \Conid{True}{}\<[57]%
\>[57]{}\mathrel{=}\Varid{l}\mathbin{\$}\Conid{Empty}{}\<[E]%
\\
\>[9]{}\hsindent{34}{}\<[43]%
\>[43]{}\mid \Varid{rz}\equiv \Conid{False}\mathrel{=}\Varid{r}\mathbin{\$}\Conid{Empty}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;((\Varid{l},\Varid{r}),\Conid{Node}\;(\Varid{rz},(\Varid{t1},\Conid{Empty})))\mid \Varid{rz}\equiv \Conid{True}\mathrel{=}\Varid{l}\mathbin{\$}\Varid{t1}{}\<[E]%
\\
\>[9]{}\hsindent{31}{}\<[40]%
\>[40]{}\mid \Varid{rz}\equiv \Conid{False}\mathrel{=}\Varid{r}\mathbin{\$}\Varid{t1}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;((\Varid{l},\Varid{r}),\Conid{Node}\;(\Varid{rz},(\Conid{Empty},\Varid{t2})))\mid \Varid{rz}\equiv \Conid{True}\mathrel{=}\Varid{l}\mathbin{\$}\Varid{t2}{}\<[E]%
\\
\>[9]{}\hsindent{31}{}\<[40]%
\>[40]{}\mid \Varid{rz}\equiv \Conid{False}\mathrel{=}\Varid{r}\mathbin{\$}\Varid{t2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{14}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pbnavLTree}\;\Varid{lt}\;\Varid{bt}\mathrel{=}\Varid{cataLTree}\;\Varid{g}\;\Varid{lt}\;\Varid{bt}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\>[B]{}\mbox{\onelinecomment  bdt testes}{}\<[E]%
\\
\>[B]{}\Varid{anita}\mathbin{::}\Conid{Bdt}\;[\mskip1.5mu \Conid{Char}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{anita}\mathrel{=}\Conid{Query}\;(\text{\ttfamily \char34 2a-feira?\char34},(\Conid{Query}\;(\text{\ttfamily \char34 Chuva~na~ida?\char34},{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}(\Conid{Dec}\;\text{\ttfamily \char34 Precisa\char34},\Conid{Query}\;(\text{\ttfamily \char34 Chuva~no~regresso\char34},{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}(\Conid{Dec}\;\text{\ttfamily \char34 Precisa\char34},\Conid{Dec}\;\text{\ttfamily \char34 N~precisa\char34})))),\Conid{Dec}\;\text{\ttfamily \char34 N~precisa\char34})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\newpage
...
\\[\blanklineskip]%
\>[B]{}\Varid{geraMosaicos}\mathbin{::}\Conid{Int}\to \fun{IO}\;[\mskip1.5mu \Conid{Picture}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{geraMosaicos}\;\Varid{x}\mathrel{=}\Varid{replicateM}\;\Varid{x}\;(\mathsf{fmap}\;\Varid{f}\mathbin{\$}\Varid{randomRIO}\;(\mathrm{0}\mathbin{::}\Conid{Integer},\mathrm{1}\mathbin{::}\Conid{Integer})){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{f}\;\Varid{a}\mathrel{=}\mathbf{if}\;\Varid{a}\equiv \mathrm{0}\;\mathbf{then}\;\Varid{truchet1}\;\mathbf{else}\;\Varid{truchet2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{geraLista}\mathbin{::}(\Conid{Int},\Conid{Int})\to [\mskip1.5mu (\Conid{Int},\Conid{Int})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{geraLista}\;(\Varid{x},\Varid{y})\mathrel{=}\map \;\Varid{f}\mathbin{\$}[\mskip1.5mu (\Varid{a},\Varid{b})\mid \Varid{a}\leftarrow [\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}\Varid{x}\mathbin{-}\mathrm{1}\mskip1.5mu],\Varid{b}\leftarrow [\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}\Varid{y}\mathbin{-}\mathrm{1}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}\;(\Varid{se1},\Varid{se2})\mathrel{=}(\Varid{x}\mathbin{*}(\mathbin{-}\mathrm{40}),\Varid{y}\mathbin{*}(\mathbin{-}\mathrm{40})){}\<[E]%
\\
\>[17]{}\hsindent{6}{}\<[23]%
\>[23]{}\Varid{f}\;(\Varid{i},\Varid{j})\mathrel{=}(\Varid{se1}\mathbin{+}(\Varid{i}\mathbin{*}\mathrm{80}),\Varid{se2}\mathbin{+}(\Varid{j}\mathbin{*}\mathrm{80})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{31}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{geraTruchet}\mathbin{::}(\Conid{Int},\Conid{Int})\to \fun{IO}\;(\Conid{Picture}){}\<[E]%
\\
\>[B]{}\Varid{geraTruchet}\;(\Varid{a},\Varid{b})\mathrel{=}\mathsf{fmap}\;\Varid{pictures}\mathbin{\$}\Varid{\Conid{M}.join}\mathbin{\$}\mathsf{fmap}\;(\Varid{permuta}\comp \map \;\uncurry{\Varid{put}})\mathbin{\$}\Varid{liftM2}\;\Varid{zip}\;\Varid{posicoes}\;\Varid{mosaicos}{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mathbf{where}\;\Varid{mosaicos}\mathrel{=}\Varid{geraMosaicos}\;(\Varid{a}\mathbin{*}\Varid{b}){}\<[E]%
\\
\>[21]{}\hsindent{6}{}\<[27]%
\>[27]{}\Varid{posicoes}\mathrel{=}\Varid{return}\mathbin{\$}\map \;(\Varid{toFloat}\times\Varid{toFloat})\mathbin{\$}\Varid{geraLista}\;(\Varid{a},\Varid{b}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{monadCompo}\mathbin{::}(\Conid{Int},\Conid{Int})\to \fun{IO}\;(){}\<[E]%
\\
\>[B]{}\Varid{monadCompo}\mathrel{=}\Varid{geraTruchet}\mathbin{>=>}\Varid{display}\;\Varid{janela}\;\Varid{white}{}\<[E]%
\\[\blanklineskip]%
