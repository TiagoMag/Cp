...
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times{(\Conid{A}\times\Conid{A})}^{\mathrm{2}}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times{\Conid{X}}^{\mathrm{2}}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times{\cata{\cdot }}^{\Varid{g}}\;\mathrm{2}}}
           \ar[l]_-{\ensuremath{\Varid{inBTree}}}
\\
...
\begin{eqnarray*}
\xymatrix@C=4cm{
    \ensuremath{\Conid{Bdt}\;\Varid{a}}
&
    \ensuremath{\Conid{A}\mathbin{+}\Conid{String}\times{\Conid{A}}^{\mathrm{2}}}
...
\xymatrix@C=4cm{
    \ensuremath{\mathsf{LTree}\;\Varid{a}}
           ...
           \ar[r]^-{\ensuremath{\Varid{outBdt}}}
&
    \ensuremath{\Conid{A}\mathbin{+}{\mathsf{LTree}\;\Varid{a}}^{\mathrm{2}}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\cata{\alt{\Varid{g1}}{\Varid{g2}}}}}
\\
     \ensuremath{{\mathsf{LTree}\;\Varid{a}}^{{\Conid{Bool}}^{\cdot }\mathbin{*}}}
&
     \ensuremath{\Conid{A}\mathbin{+}{({\Conid{Ltree}\;\Varid{a}}^{\Conid{Bool}\mathbin{*}})}^{\mathrm{2}}}
...
&
    \ensuremath{\Conid{A}\mathbin{+}{\mathsf{LTree}\;\Varid{a}}^{\mathrm{2}}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\cata{\alt{\Varid{g1}}{\Varid{g2}}}}}
\\
     \ensuremath{{\mathsf{LTree}\;\Varid{a}}^{\fun{BTree} \;\Conid{Bool}}}
&
     \ensuremath{\Conid{A}\mathbin{+}{({\Conid{Ltree}\;\Varid{a}}^{\fun{BTree} \;\Conid{Bool}})}^{\mathrm{2}}}
           \ar[l]^-{\ensuremath{\alt{\Varid{g1}}{\Varid{g2}}}}
}
\end{eqnarray*}
